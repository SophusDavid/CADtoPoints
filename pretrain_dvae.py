...
import argparse
from dataset.cad_dataset import get_dataloader,get_GS_dataloader
from config import ConfigAE
from utils import cycle
from trainer import TrainerAE,TrainerDVAE
...
def main():
    ...
    # create dataloader
    train_loader = get_GS_dataloader('train', cfg)
    val_loader = get_GS_dataloader('validation', cfg)
    val_loader_all = get_GS_dataloader('validation', cfg)
